...
if __name__ == '__main__':
    ...
    test_db.add_contact('test1', 'user_Vasya')
    #print(test_db.get_contacts('test1'))
    #print(test_db.message_history())
    print(test_db.login_history('test1'))

    #test_db.del_contact('test1', 'test2')
    #print(test_db.get_contacts('test1'))

    #test_db.add_contact('user_Vasya', 'test2')
    #test_db.add_contact('user_Vasya', 'test1')
    #print(test_db.get_contacts('user_Vasya'))
